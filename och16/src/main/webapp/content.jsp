...
<body>
	<table border="1">
	<caption><h2>게시판 상세내용 ${board.num}</h2></caption>
	...
	<input type="button" value="수정"
				onclick="location.href='updateForm.do?num=${board.num}&page=Num=${pageNum}'">
	<input type="button" value="답변작성"
				onclick="location.href='writeForm.do?num=${board.num}&page=Num=${pageNum}'">
	<input type="button" value="삭제"
				onclick="location.href='deleteForm.do?num=${board.num}&page=Num=${pageNum}'">
	<input type="button" value="목록"
				onclick="location.href='list.do?num=${board.num}&page=Num=${pageNum}'"></td></tr>
	</table>
